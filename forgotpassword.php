        ...
        <main>
            <div class="form-container">
                <div class="form-selection">
                    <span class="form-selector login-selector" onclick="login()">Enter your Email </span>
                    <hr class="indicator" id="login-register-indicator" />
                </div>
                <form id="login-form-id" class="form login-form" action="forgotpasswordsystem.php" method="post">
